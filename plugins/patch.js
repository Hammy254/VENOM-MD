      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/a60fec3ac6521afdc2044.jpg",
            {
        ...
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/732f9e0de80c9c2cca40b.jpg",
            {
              responseType: "arraybuffer",
            }
          );
...
const message = `*𝐕𝐄𝐍𝐎𝐌-𝗠𝗗-𝗜𝗡-𝗥𝗨𝗡𝗡𝗜𝗡𝗚-𝗙𝗥𝗢𝗠:* ${uptimeHours}h ${uptimeMinutes}ᴍ ${uptimeSeconds}s\n \t_ʜᴇʀᴇ's ᴍᴏʀᴇ ɪɴғᴏ_\n*ʀᴀᴍ ᴜsᴀɢᴇ:* ${ramUsage.toFixed(2)} MB\n*ᴄᴘᴜ ɴᴀᴍᴇ:* ${cpuModel}`;}`;
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
